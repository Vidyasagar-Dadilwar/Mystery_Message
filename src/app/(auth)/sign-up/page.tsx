...
const page = () => {
  ...
  // debounce means wait for 500ms before sending the request
  ...
  const onSubmit = async (data: z.infer<typeof signUpSchema>) => {
    ...
    try {
      ...
      router.replace(`/verify/${data.username}`); // redirect to verify page
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="m-5 w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-2xl">
        <div className="text-center">
          ...
          <p className="mb-4">
            Sign up to start your anonynous messaging journey
          </p>
        </div>
